...
def handler(event, context):
    ...
    # Normalize path
    path = full_path
    prefixes = ['/.netlify/functions/api', '/api']
    for p in prefixes:
    ...
    if path == 'ping':
        return {"statusCode": 200, "headers": headers, "body": "pong-v6-hybrid"}
    ...
    try:
        ...
        return {"statusCode": 404, "headers": headers, "body": f"Not Found: path={path}"}
